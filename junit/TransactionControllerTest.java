...
public class TransactionControllerTest {
    ...
    public void testGetAllTransactions() throws Exception {
        ...
        Customer customer1 = new Customer(1L, "John Doe", "john@example.com", "1234567890", "123 Main St", "Cityville", "Regionland", "12345");
        ...
        Transaction newTransaction1 = new Transaction(null,createdAccount1,"NEFT",BigDecimal.valueOf(500),new Date());
        Transaction createdTransaction1 = new Transaction(1L,createdAccount1,"NEFT",BigDecimal.valueOf(500),new Date());

        Customer customer2 = new Customer(2L, "Jack Torson", "jack@example.com", "9087654321", "321 Main St", "NY", "Regionland", "12345");
        ...
        Transaction newTransaction2 = new Transaction(null,createdAccount2,"NEFT",BigDecimal.valueOf(500),new Date());
        Transaction createdTransaction2 = new Transaction(1L,createdAccount2,"NEFT",BigDecimal.valueOf(500),new Date());
    ...
    public void testCreateTransaction() throws Exception {
        ...
        Transaction createdTransaction = new Transaction(1L,createdAccount,"NEFT",BigDecimal.valueOf(500),new Date());
    ...
    public void testUpdateTransactionById() throws Exception {
        ...
        Transaction updatedTransaction = new Transaction(1L,createdAccount,"NEFT",BigDecimal.valueOf(700),new Date());

        when(transactionRepository.findById(anyLong())).thenReturn(Optional.of(existingTransaction));
        when(transactionRepository.save(any(Transaction.class))).thenReturn(updatedTransaction);

        mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/transactions/1")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testGetTransactionById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/transactions/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.transactionId").value(existingTransaction.getTransactionId()))
                .andExpect(jsonPath("$.transactionType").value(existingTransaction.getTransactionType()))
                .andExpect(jsonPath("$.amount").value(existingTransaction.getAmount()))
                .andExpect(jsonPath("$.transactionDate").exists()); // Assuming you just want to check for its existence
    }
    ...
    public void testDeleteTransactionById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/transactions/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.Transaction has been Deleted").value(true));
    }
