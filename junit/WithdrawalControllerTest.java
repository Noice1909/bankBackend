...
public class WithdrawalControllerTest {
    ...
    void testUpdateWithdrawalById() throws Exception {
        ...
        Withdrawal updatedWithdrawal = new Withdrawal(account, customer, BigDecimal.valueOf(700));
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/withdrawal/1")
                        ...
                        .content("completed"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.withdrawalAmount").value(700));
    }
